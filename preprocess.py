...
if hp.dataset in ["LibriTTS", "VCTK", "LJSpeech", "ChenNing"]:
...
class Preprocessor:
    ...
    def mfa(self):
        ...
        mfa_pretrain_path = '/content/drive/Shareddrives/Lab/ChenNing/mandarin_dict.txt'
        cmd = f"{mfa_bin_path} {mfa_in_dir} {mfa_pretrain_path} mandarin {mfa_out_dir} -j 8 -v"
        os.system(cmd)
